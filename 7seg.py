...
# コロン表示用のキャンバスのサイズ
CANVAS_WIDTH_COLON = 20

# 色の設定
COLOR_BG = "black"  # 時計の背景色
COLOR_SEG_ON = "red"  # セグ点灯時の色
...
class ColonCanvas(tkinter.Canvas):
    ...
    def draw(self):
        ...
        center_y = (9) * ColonCanvas.canvas_height / 10
...
class Drawer:
    ...
    def update(self, hour, minute):
        ...
        if hwnd:
            ...
            e.append(window_size[0]+24)
            e.append(window_size[1]+60)
            e.append(window_size[2]*3/2-9)
            e.append(window_size[3]*3/2-9)
...
class DigitalClock:
    ...
    def update(self):
        ...
        self.drawer.update(hour, minute)
